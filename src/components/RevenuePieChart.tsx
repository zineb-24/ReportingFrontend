...
const RevenueDistribution: React.FC<RevenueDistributionProps> = ({ 
  ...
  // Changed default category from 'subscription' to 'payment_method'
  const [category, setCategory] = useState<'payment_method' | 'subscription' | 'agent'>('payment_method');
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);

  // Category options for the dropdown - reordered to show payment_method first
  ...
  return (
    <div className="distribution-container">
      <div className="distribution-header">
        ...
        {/* Desktop version - buttons (reordered to show payment_method first) */}
