...
const UserDashboard: React.FC = () => {
  ...
  // Effect for handling gym tab scrolling
  useEffect(() => {
    const handleGymTabScroll = () => {
      const tabs = document.querySelector('.gym-tabs');
      const prevButton = document.querySelector('.prev-arrow');
      const nextButton = document.querySelector('.next-arrow');
      
      if (!tabs || !prevButton || !nextButton) return;
  ...
  const checkTabsScrollable = () => {
    ...
    if (tabsContainer) {
      // If the scroll width is greater than the visible width, it's scrollable
          ...
          {activeMenuItem === 'dashboard' && (
            <>
              ...
              <div className="customer-gym-selector">
                <button className="customer-nav-arrow prev-arrow">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path fillRule="evenodd" d="M7.72 12.53a.75.75 0 010-1.06l7.5-7.5a.75.75 0 111.06 1.06L9.31 12l6.97 6.97a.75.75 0 11-1.06 1.06l-7.5-7.5z" clipRule="evenodd" />
                  </svg>
                </button>
                
                <div className="customer-gym-tabs">
                  {salles.map((salle) => (
                    <div 
                      key={salle.id_salle} 
                ...
                <button className="customer-nav-arrow next-arrow">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="customer-stats-container">
                  <div className="customer-stats-scroll-area" ref={statsScrollRef}>
                    ...
                    <div className="customer-stat-card">
                      <div className="customer-stat-content">
                        ...
                        <div className="customer-stat-icon payment-icon">
                    ...
                    <div className="customer-stat-card">
                      <div className="customer-stat-content">
                        ...
                        <div className="customer-stat-icon client-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="customer-stat-icon-svg">
                  ...
                  <div className="customer-stat-card">
                    <div className="customer-stat-content">
                      ...
                      <div className="customer-stat-icon subscription-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="customer-stat-icon-svg">
                  ...
                  <div className="customer-stat-card">
                    <div className="customer-stat-content">
                      ...
                      <div className="customer-stat-icon expired-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="customer-stat-icon-svg">
                  ...
                  {/* <button 
                    className="customer-stats-nav-arrow stats-prev"
                  ...
                  <button 
                    className="customer-stats-nav-arrow stats-next"
                  ...
                  {/* Additional dashboard content area for future components */}
                  <div className="customer-dashboard-content">
                    {/* Future chart or table components will go here */}
                    {!selectedSalle && (
                    ...
                    {/* You can add additional dashboard components here later */}
                  </div>
                  </>
                  )}
